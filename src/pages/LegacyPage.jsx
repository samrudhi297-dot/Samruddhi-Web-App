...
import { injectTestimonials } from '../utils/injectTestimonials.js'
      ...
      try {
        ...
        const initTheme = async () => {
          ...
          try {
            ...
            reinitializeLegacyTheme(containerRef.current, { skipTestimonialSlider: isHome })

            if (isHome) {
              await injectTestimonials(containerRef.current)
            }
