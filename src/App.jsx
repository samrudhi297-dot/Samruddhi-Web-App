...
import AdminInquiryDetail from './pages/AdminInquiryDetail.jsx'
...
function AppRoutes() {
  return (
    <Routes>
      ...
      <Route path="/admin/products/new" element={<AdminProductEditor mode="add" />} />
      <Route path="/admin/products/:slug/edit" element={<AdminProductEditor mode="edit" />} />
